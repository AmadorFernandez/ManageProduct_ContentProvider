...
public class DataBaseManager {
    ...
    public void addInvoiceLine(InvoiceLine invoiceLine){
        ...
        params.put(DataBaseContract.InvoiceLineEntry.COLUMN_IL_AMOUNT, invoiceLine.getAmount());
        params.put(DataBaseContract.InvoiceLineEntry.INVOICE_ID, invoiceLine.getIdInvoice());
        params.put(DataBaseContract.InvoiceLineEntry.INVOICE_ID, invoiceLine.getOrderProduct());
        params.put(DataBaseContract.InvoiceLineEntry.INVOICE_ID, invoiceLine.getPrice());
        params.put(DataBaseContract.InvoiceLineEntry.INVOICE_ID, invoiceLine.getIdProduct());
