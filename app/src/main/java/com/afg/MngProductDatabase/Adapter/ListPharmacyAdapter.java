...
public class ListPharmacyAdapter extends SimpleCursorAdapter {


    public ListPharmacyAdapter(Context context, int layout, Cursor c, String[] from, int[] to, int flags) {
